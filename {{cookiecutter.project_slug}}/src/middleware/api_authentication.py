...
TABLE_NAME_MAPPING = {
    "LOCAL": "test-{{ cookiecutter.project_slug }}-APIKeys",
    "TEST": "test-{{ cookiecutter.project_slug }}-APIKeys",
    "DEV": "test-{{ cookiecutter.project_slug }}-APIKeys",
    "PROD": "{{ cookiecutter.project_slug }}-APIKeys",
}
